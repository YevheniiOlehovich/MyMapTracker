...
// URL вашого сервера
const url = 'http://localhost:5000/geo_data/cadastre';

// Читаємо дані з файлу cadastre_data.json
const cadastreFilePath = path.resolve('./helpres/cadastre_data.json');
const cadastreData = JSON.parse(fs.readFileSync(cadastreFilePath, 'utf8'));
...
sendDataInChunks(cadastreData, 10);