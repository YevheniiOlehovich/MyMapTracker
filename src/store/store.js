...
import layersReducer from './layersList';
import mapCenterSliceReducer from './mapCenterSlice';
import landSquattingReducer from './landSquattingSlice'; // Імпортуємо редюсер для land_squatting
...
const store = configureStore({
    reducer: {
        ...
        layers: layersReducer,
        mapCenter: mapCenterSliceReducer,
        landSquatting: landSquattingReducer, // Додаємо редюсер для land_squatting
    },
});
