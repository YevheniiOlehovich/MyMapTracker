...
//         console.log(`Toggling visibility for field ${fieldId}: ${!currentVisibility}`);
//         toggleFieldVisibility.mutate({ fieldId, isVisible: !currentVisibility });
//     };
...
//                             <Styles.btnBlock>
//                                 <Styles.btn onClick={() => handleToggleFieldVisibility(field._id, field.visibility)}>
