...
import { useOperationsData, useDeleteOperation } from "../../hooks/useOperationsData";
import { openAddOperationModal } from "../../store/modalSlice";
import {
  createColumnHelper,
  getCoreRowModel,
  getSortedRowModel,
...
export default function OperationsTab() {
  ...
  const handleAdd = () => dispatch(openAddOperationModal());
  const handleEdit = (id) => dispatch(openAddOperationModal(id));
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("name", { id: "name", header: "Назва операції" }),
