...
// /**
//  * Розбиває GPS-дані на сегменти руху та парковок
...
//   // 1️⃣ Фільтруємо нулі та некоректні точки
...
//     // Точки близько одна до одної → потенційна зупинка
//     if (distance < 0.005) { // ~5 м
//       if (currentType === 'moving') {
//         // закриваємо руховий сегмент
...
//       }
//     } else {
//       segments.push(createSegment(currentSegment, 'moving', imei));
//     }
//   }
