    ...
    const geoOptions = [
        {
            value: "fields",
            checked: showFields,
            handler: () => dispatch(toggleFields()),
            label: "Поля",
        },
        {
            value: "cadastre",
            checked: showCadastre,
            handler: () => dispatch(toggleCadastre()),
            label: "Кадастр",
        },
        {
            value: "ownPlots",
            checked: showOwnPlots,
            handler: () => dispatch(toggleOwnPlots()),
            label: "Ділянки у власності",
        },
        {
            value: "ladaRentPlots",
            checked: showLadaRentPlots,
            handler: () => dispatch(toggleLadaRentPlots()),
            label: "Оренда (ЛАДА)",
        },
        {
            value: "krokRentPlots",
            checked: showKrokRentPlots,
            handler: () => dispatch(toggleKrokRentPlots()),
            label: "Оренда (КРОК)",
        },
        {
            value: "geozones",
            checked: showGeozones,
            handler: () => dispatch(toggleGeozones()),
            label: "Геозони",
        },
        {
            value: "units",
            checked: showUnits,
            handler: () => dispatch(toggleUnits()),
            label: "Господарчі ділянки",
        },
    ];
